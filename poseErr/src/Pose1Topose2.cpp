...
namespace pdal
{
    ...
    void Pose1Topose2::filter(PointView &view)
    {
        ...
        std::cout << "(x_axisd, y_axisd z_axisd): "
                  ...
                  << ") (units: degree)"
                  << std::endl;
        std::cout << "RMS: " << sqrt((x_axisd_angle * x_axisd_angle + y_axisd_angle * y_axisd_angle + z_axisd_angle * z_axisd_angle) / 3)
                  << " degree"
                  << std::endl;
        ...
        std::cout << "Err_tranlation:" << std::endl
                  ...
                  << ") (units: cm)"
                  << std::endl;
        std::cout << "RMS: " << sqrt((m_error.translation()[0] * m_error.translation()[0] + m_error.translation()[1] * m_error.translation()[1] + m_error.translation()[2] * m_error.translation()[2]) / 3)
                  << " cm"
                  << std::endl;
    }
